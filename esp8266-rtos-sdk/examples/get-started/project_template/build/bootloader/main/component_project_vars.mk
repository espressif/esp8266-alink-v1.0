...
COMPONENT_LDFLAGS += -L$(BUILD_DIR_BASE)/main -lmain -L $(PROJECT_PATH)/main -T esp8266.bootloader.ld -T $(IDF_PATH)/components/esp8266/ld/esp8266.rom.ld -T esp8266.bootloader.rom.ld
